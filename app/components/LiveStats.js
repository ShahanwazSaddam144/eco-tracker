      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          <div>
            ...
            <h2 className="text-gray-900 text-3xl md:text-4xl font-bold tracking-tight">
              Environmental Telemetry
            </h2>
          </div>

          <div className="bg-green-50 border border-green-200 text-green-600 px-4 py-2 rounded-md font-mono text-xs flex items-center gap-4 shadow-sm">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.id}
                className={`cursor-pointer relative p-6 bg-white border-2 border-slate-200 rounded-xl shadow-sm transition-all duration-500 overflow-hidden group ${stat.borderColor}`}
              >
                <div
